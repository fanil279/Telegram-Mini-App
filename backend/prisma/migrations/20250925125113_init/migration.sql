...
-- CreateTable
CREATE TABLE "base"."tg_channel_subscribers" (
    "id" BIGSERIAL NOT NULL,
    "user_id" BIGINT NOT NULL,
    ...
    CONSTRAINT "tg_channel_subscribers_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "base"."users_avatars" (
    ...
    "is_main_profile_photo" BOOLEAN NOT NULL DEFAULT false,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "messages_match_id_sender_telegram_id_receiver_telegram_id_r_idx" ON "base"."messages"("match_id", "sender_telegram_id", "receiver_telegram_id", "reply_to_id", "created_at");
...
-- CreateIndex
CREATE INDEX "tg_channel_subscribers_user_id_channel_id_idx" ON "base"."tg_channel_subscribers"("user_id", "channel_id");
...
-- AddForeignKey
ALTER TABLE "base"."messages" ADD CONSTRAINT "messages_sender_telegram_id_fkey" FOREIGN KEY ("sender_telegram_id") REFERENCES "base"."users"("telegramId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "base"."messages" ADD CONSTRAINT "messages_receiver_telegram_id_fkey" FOREIGN KEY ("receiver_telegram_id") REFERENCES "base"."users"("telegramId") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "base"."tg_channel_subscribers" ADD CONSTRAINT "tg_channel_subscribers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "base"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
